...
impl BODINTVALR {
    ...
    #[doc = "Checks if the value of the field is `RESERVED_0X0`"]
    #[inline]
    pub fn is_reserved_0x0(&self) -> bool {
        *self == BODINTVALR::RESERVED_0X0
    }
...
impl<'a> _BODINTVALW<'a> {
    ...
    #[doc = "Reserved."]
    #[inline]
    pub fn reserved_0x0(self) -> &'a mut W {
        self.variant(BODINTVALW::RESERVED_0X0)
    }
    #[doc = "Level 1:The interrupt assertion threshold voltage is 2.22 V; the interrupt de-assertion threshold voltage is 2.35 V."]
    #[inline]
