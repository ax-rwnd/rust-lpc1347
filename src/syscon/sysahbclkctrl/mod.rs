...
impl R {
    ...
    #[doc = "Bit 0 - Enables the clock for the AHB, the APB bridge, the Cortex-M3 FCLK and HCLK, SysCon, and the PMU. This bit is read only and always reads as 1."]
    #[inline]
    ...
    #[doc = "Bit 2 - Enables clock for SRAM0."]
    #[inline]
    ...
    #[doc = "Bit 27 - Enables USB SRAM block located at 0x2000 4000 to 0x2000 4800."]
    #[inline]
