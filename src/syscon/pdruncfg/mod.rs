...
pub enum USBPAD_PDR {
    ...
    USB_TRANSCEIVER_POWER_UP,
    #[doc = "USB transceiver powered down (suspend mode)"]
    USB_TRANSCEIVER_POWER_DOWN_SUSPEND,
}
impl USBPAD_PDR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    #[inline]
    ...
    pub fn bit(&self) -> bool {
        match *self {
            USBPAD_PDR::USB_TRANSCEIVER_POWER_UP => false,
            USBPAD_PDR::USB_TRANSCEIVER_POWER_DOWN_SUSPEND => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> USBPAD_PDR {
        match value {
            false => USBPAD_PDR::USB_TRANSCEIVER_POWER_UP,
            true => USBPAD_PDR::USB_TRANSCEIVER_POWER_DOWN_SUSPEND,
        }
    }
    #[doc = "Checks if the value of the field is `USB_TRANSCEIVER_POWER_UP`"]
    #[inline]
    pub fn is_usb_transceiver_power_up(&self) -> bool {
        *self == USBPAD_PDR::USB_TRANSCEIVER_POWER_UP
    }
    #[doc = "Checks if the value of the field is `USB_TRANSCEIVER_POWER_DOWN_SUSPEND`"]
    #[inline]
    pub fn is_usb_transceiver_power_down_suspend(&self) -> bool {
        *self == USBPAD_PDR::USB_TRANSCEIVER_POWER_DOWN_SUSPEND
    }
}
...
impl USBPAD_PDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            USBPAD_PDW::USB_TRANSCEIVER_POWER_UP => false,
            USBPAD_PDW::USB_TRANSCEIVER_POWER_DOWN_SUSPEND => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _USBPAD_PDW<'a> {
    ...
    #[doc = "USB transceiver powered"]
    #[inline]
    pub fn usb_transceiver_power_up(self) -> &'a mut W {
        self.variant(USBPAD_PDW::USB_TRANSCEIVER_POWER_UP)
    }
    #[doc = "USB transceiver powered down (suspend mode)"]
    #[inline]
    pub fn usb_transceiver_power_down_suspend(self) -> &'a mut W {
        self.variant(USBPAD_PDW::USB_TRANSCEIVER_POWER_DOWN_SUSPEND)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
