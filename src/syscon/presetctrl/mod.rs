...
impl SSP1_RST_NR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            SSP1_RST_NR::RESETS_THE_SSP0_PERI => false,
    ...
    pub fn _from(value: bool) -> SSP1_RST_NR {
        match value {
            false => SSP1_RST_NR::RESETS_THE_SSP0_PERI,
    ...
    #[inline]
    pub fn is_resets_the_ssp0_peri(&self) -> bool {
        *self == SSP1_RST_NR::RESETS_THE_SSP0_PERI
    }
...
impl SSP1_RST_NW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            SSP1_RST_NW::RESETS_THE_SSP0_PERI => false,
...
impl<'a> _SSP1_RST_NW<'a> {
    ...
    #[inline]
    pub fn resets_the_ssp0_peri(self) -> &'a mut W {
        self.variant(SSP1_RST_NW::RESETS_THE_SSP0_PERI)
    }
    #[doc = "SSP1 reset de-asserted."]
    #[inline]
