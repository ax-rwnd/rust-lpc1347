...
impl USBPAD_PDR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ...
            USBPAD_PDR::USB_TRANSCEIVER_POWER_DOWN => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> USBPAD_PDR {
        match value {
            ...
            true => USBPAD_PDR::USB_TRANSCEIVER_POWER_DOWN,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `USB_TRANSCEIVER_POWER_DOWN`"]
    #[inline]
    pub fn is_usb_transceiver_power_down(&self) -> bool {
        *self == USBPAD_PDR::USB_TRANSCEIVER_POWER_DOWN
    }
}
...
impl USBPAD_PDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ...
            USBPAD_PDW::USB_TRANSCEIVER_POWER_DOWN => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _USBPAD_PDW<'a> {
    ...
    #[doc = "USB transceiver powered down"]
    #[inline]
    pub fn usb_transceiver_power_down(self) -> &'a mut W {
        self.variant(USBPAD_PDW::USB_TRANSCEIVER_POWER_DOWN)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
