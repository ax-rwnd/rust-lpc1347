...
impl CTMR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            CTMR::TIMER_MODE_EVERY_RISING => 0,
    ...
    pub fn _from(value: u8) -> CTMR {
        match value {
            0 => CTMR::TIMER_MODE_EVERY_RISING,
    ...
    #[doc = "Checks if the value of the field is `TIMER_MODE_EVERY_RISING`"]
    #[inline]
    pub fn is_timer_mode_every_rising(&self) -> bool {
        *self == CTMR::TIMER_MODE_EVERY_RISING
    }
...
impl CISR {
    ...
    #[doc = "Checks if the value of the field is `RESERVED_0X1`"]
    #[inline]
    pub fn is_reserved_0x1(&self) -> bool {
        *self == CISR::RESERVED_0X1
    }
...
pub enum SELCCR {
    ...
    RISING_EDGE_OF_CT16B0_CAP0,
    #[doc = "Falling Edge of CT16B0_CCAP0 clears the timer (if bit 4 is set)."]
    FALLING_EDGE_OF_CT16B0_CAP0,
    #[doc = "Reserved."]
    RESERVED_0X2,
    #[doc = "Reserved."]
    RESERVED_0X3,
    #[doc = "Rising Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    RISING_EDGE_OF_CT16B0_CAP1,
    #[doc = "Falling Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    FALLING_EDGE_OF_CT160_CAP1,
    #[doc = r" Reserved"]
    _Reserved(u8),
}
impl SELCCR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            SELCCR::RISING_EDGE_OF_CT16B0_CAP0 => 0,
            SELCCR::FALLING_EDGE_OF_CT16B0_CAP0 => 1,
            SELCCR::RESERVED_0X2 => 2,
            SELCCR::RESERVED_0X3 => 3,
            SELCCR::RISING_EDGE_OF_CT16B0_CAP1 => 4,
            SELCCR::FALLING_EDGE_OF_CT160_CAP1 => 5,
    ...
    pub fn _from(value: u8) -> SELCCR {
        match value {
            0 => SELCCR::RISING_EDGE_OF_CT16B0_CAP0,
            1 => SELCCR::FALLING_EDGE_OF_CT16B0_CAP0,
            2 => SELCCR::RESERVED_0X2,
            3 => SELCCR::RESERVED_0X3,
            4 => SELCCR::RISING_EDGE_OF_CT16B0_CAP1,
            5 => SELCCR::FALLING_EDGE_OF_CT160_CAP1,
            i => SELCCR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `RISING_EDGE_OF_CT16B0_CAP0`"]
    #[inline]
    pub fn is_rising_edge_of_ct16b0_cap0(&self) -> bool {
        *self == SELCCR::RISING_EDGE_OF_CT16B0_CAP0
    }
    #[doc = "Checks if the value of the field is `FALLING_EDGE_OF_CT16B0_CAP0`"]
    #[inline]
    pub fn is_falling_edge_of_ct16b0_cap0(&self) -> bool {
        *self == SELCCR::FALLING_EDGE_OF_CT16B0_CAP0
    }
    #[doc = "Checks if the value of the field is `RESERVED_0X2`"]
    #[inline]
    pub fn is_reserved_0x2(&self) -> bool {
        *self == SELCCR::RESERVED_0X2
    }
    #[doc = "Checks if the value of the field is `RESERVED_0X3`"]
    #[inline]
    pub fn is_reserved_0x3(&self) -> bool {
        *self == SELCCR::RESERVED_0X3
    }
    #[doc = "Checks if the value of the field is `RISING_EDGE_OF_CT16B0_CAP1`"]
    #[inline]
    pub fn is_rising_edge_of_ct16b0_cap1(&self) -> bool {
        *self == SELCCR::RISING_EDGE_OF_CT16B0_CAP1
    }
    #[doc = "Checks if the value of the field is `FALLING_EDGE_OF_CT160_CAP1`"]
    #[inline]
    pub fn is_falling_edge_of_ct160_cap1(&self) -> bool {
        *self == SELCCR::FALLING_EDGE_OF_CT160_CAP1
    }
}
...
impl CTMW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            CTMW::TIMER_MODE_EVERY_RISING => 0,
...
impl<'a> _CTMW<'a> {
    ...
    #[doc = "Timer Mode: every rising PCLK edge"]
    #[inline]
    pub fn timer_mode_every_rising(self) -> &'a mut W {
        self.variant(CTMW::TIMER_MODE_EVERY_RISING)
    }
    #[doc = "Counter Mode: TC is incremented on rising edges on the CAP input selected by bits 3:2."]
    #[inline]
...
impl<'a> _CISW<'a> {
    ...
    #[doc = "Reserved."]
    #[inline]
    pub fn reserved_0x1(self) -> &'a mut W {
        self.variant(CISW::RESERVED_0X1)
    }
    #[doc = "CT16B0_CAP1."]
    #[inline]
...
impl SELCCW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            SELCCW::RISING_EDGE_OF_CT16B0_CAP0 => 0,
            SELCCW::FALLING_EDGE_OF_CT16B0_CAP0 => 1,
            SELCCW::RESERVED_0X2 => 2,
            SELCCW::RESERVED_0X3 => 3,
            SELCCW::RISING_EDGE_OF_CT16B0_CAP1 => 4,
            SELCCW::FALLING_EDGE_OF_CT160_CAP1 => 5,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SELCCW<'a> {
    ...
    #[doc = "Rising Edge of CT16B0_CAP0 clears the timer (if bit 4 is set)."]
    #[inline]
    pub fn rising_edge_of_ct16b0_cap0(self) -> &'a mut W {
        self.variant(SELCCW::RISING_EDGE_OF_CT16B0_CAP0)
    }
    #[doc = "Falling Edge of CT16B0_CCAP0 clears the timer (if bit 4 is set)."]
    #[inline]
    pub fn falling_edge_of_ct16b0_cap0(self) -> &'a mut W {
        self.variant(SELCCW::FALLING_EDGE_OF_CT16B0_CAP0)
    }
    #[doc = "Reserved."]
    #[inline]
    pub fn reserved_0x2(self) -> &'a mut W {
        self.variant(SELCCW::RESERVED_0X2)
    }
    #[doc = "Reserved."]
    #[inline]
    pub fn reserved_0x3(self) -> &'a mut W {
        self.variant(SELCCW::RESERVED_0X3)
    }
    #[doc = "Rising Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    #[inline]
    pub fn rising_edge_of_ct16b0_cap1(self) -> &'a mut W {
        self.variant(SELCCW::RISING_EDGE_OF_CT16B0_CAP1)
    }
    #[doc = "Falling Edge of CT16B0_CAP1 clears the timer (if bit 4 is set)."]
    #[inline]
    pub fn falling_edge_of_ct160_cap1(self) -> &'a mut W {
        self.variant(SELCCW::FALLING_EDGE_OF_CT160_CAP1)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
