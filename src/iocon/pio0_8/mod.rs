...
impl FUNCR {
    ...
    #[doc = "Checks if the value of the field is `ARM_TRACE_CLK`"]
    #[inline]
    pub fn is_arm_trace_clk(&self) -> bool {
        *self == FUNCR::ARM_TRACE_CLK
    }
}
...
impl<'a> _FUNCW<'a> {
    ...
    #[doc = "ARM_TRACE_CLK"]
    #[inline]
    pub fn arm_trace_clk(self) -> &'a mut W {
        self.variant(FUNCW::ARM_TRACE_CLK)
    }
