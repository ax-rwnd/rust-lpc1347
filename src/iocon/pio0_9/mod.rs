...
impl FUNCR {
    ...
    #[doc = "Checks if the value of the field is `ARM_TRACE_SWV`"]
    #[inline]
    pub fn is_arm_trace_swv(&self) -> bool {
        *self == FUNCR::ARM_TRACE_SWV
    }
}
...
impl<'a> _FUNCW<'a> {
    ...
    #[doc = "ARM_TRACE_SWV"]
    #[inline]
    pub fn arm_trace_swv(self) -> &'a mut W {
        self.variant(FUNCW::ARM_TRACE_SWV)
    }
