...
impl<'a> _I2CMODEW<'a> {
    ...
    pub fn reserved_0x3(self) -> &'a mut W {
        self.variant(I2CMODEW::RESERVED_0X3)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl R {
    ...
    #[doc = "Bits 8:9 - Selects I2C mode (see Section 6.3.8). Select Standard mode (I2CMODE = 00, default) or Standard I/O functionality (I2CMODE = 01) if the pin function is GPIO (FUNC = 0)."]
    #[inline]
