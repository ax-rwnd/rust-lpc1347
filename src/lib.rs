...
#[no_mangle]
pub static __INTERRUPTS: [Vector; 31] = [Vector { _handler: PIN_INT0 }, Vector { _handler: PIN_INT1 }, Vector { _handler: PIN_INT2 }, Vector { _handler: PIN_INT3 }, Vector { _handler: PIN_INT4 }, Vector { _handler: PIN_INT5 }, Vector { _handler: PIN_INT6 }, Vector { _handler: PIN_INT7 }, Vector { _handler: GINT0 }, Vector { _handler: GINT1 }, Vector { _reserved: 0 }, Vector { _reserved: 0 }, Vector { _handler: RIT_IRQ }, Vector { _reserved: 0 }, Vector { _handler: SSP1 }, Vector { _handler: I2C }, Vector { _handler: CT16B0 }, Vector { _handler: CT16B1 }, Vector { _handler: CT32B0 }, Vector { _handler: CT32B1 }, Vector { _handler: SSP0 }, Vector { _handler: USART }, Vector { _handler: USB_IRQ }, Vector { _handler: USB_FIQ }, Vector { _handler: ADC }, Vector { _handler: WWDT }, Vector { _handler: BOD_IRQ }, Vector { _handler: FLASH_IRQ }, Vector { _reserved: 0 }, Vector { _reserved: 0 }, Vector { _handler: USBWAKEUP }];
...
#[doc = "Repetitive Interrupt Timer (RI timer)"]
pub struct RITIMER {
    _marker: PhantomData<*const ()>,
}
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals { I2C: I2C { _marker: PhantomData }, WWDT: WWDT { _marker: PhantomData }, CT16B0: CT16B0 { _marker: PhantomData }, CT16B1: CT16B1 { _marker: PhantomData }, CT32B0: CT32B0 { _marker: PhantomData }, CT32B1: CT32B1 { _marker: PhantomData }, USART: USART { _marker: PhantomData }, ADC: ADC { _marker: PhantomData }, PMU: PMU { _marker: PhantomData }, FLASHCTRL: FLASHCTRL { _marker: PhantomData }, SSP0: SSP0 { _marker: PhantomData }, IOCON: IOCON { _marker: PhantomData }, SYSCON: SYSCON { _marker: PhantomData }, GPIO_PIN_INT: GPIO_PIN_INT { _marker: PhantomData }, SSP1: SSP1 { _marker: PhantomData }, GPIO_GROUP_INT0: GPIO_GROUP_INT0 { _marker: PhantomData }, GPIO_GROUP_INT1: GPIO_GROUP_INT1 { _marker: PhantomData }, RITIMER: RITIMER { _marker: PhantomData }, USB: USB { _marker: PhantomData }, GPIO_PORT: GPIO_PORT { _marker: PhantomData } }
    }
}
