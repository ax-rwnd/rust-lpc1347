...
impl SSDISR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ...
            SSDISR::NOT_SEND_START_STOP => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> SSDISR {
        match value {
            ...
            true => SSDISR::NOT_SEND_START_STOP,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `NOT_SEND_START_STOP`"]
    #[inline]
    pub fn is_not_send_start_stop(&self) -> bool {
        *self == SSDISR::NOT_SEND_START_STOP
    }
}
...
impl SSDISW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ...
            SSDISW::NOT_SEND_START_STOP => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SSDISW<'a> {
    ...
    #[doc = "Do not send start/stop bits."]
    #[inline]
    pub fn not_send_start_stop(self) -> &'a mut W {
        self.variant(SSDISW::NOT_SEND_START_STOP)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
